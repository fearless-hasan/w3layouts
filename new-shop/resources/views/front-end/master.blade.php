...
<html>
<head>
    <title>New Shop a E-Commerce Online Shopping Category Flat Bootstrap Responsive Website Template | @yield('title')</title>
    <!--css-->
        ...
        <div class="container">
            <div class="logo-nav">
                <div class="logo-nav-left">
                    <h1><a href="{{ route('new-shop-home') }}">New Shop <span>Shop anywhere</span></a></h1>
                </div>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="{{ route('new-shop-home') }}" class="act">Home</a></li>
                                <!-- Mega Menu -->
                                <li class="dropdown">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu1</h6>
                                                    <li><a href="{{ route('new-shop-category-product') }}">Clothing</a></li>
                                ...
                                <li><a href="{{ route('new-shop-mail-us') }}">Mail Us</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
    ...
    <div class="container">
        <div class="footer-grids">
            ...
            <div class="col-md-3 footer-grid">
                <h4>Information</h4>
                <ul>
                    <li><a href="{{ route('new-shop-home') }}">Home</a></li>
...
<div class="copy-section">
    <div class="container">
        <div class="copy-left">
            <p>&copy; 2018 New Shop . All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
        </div>
